...
<body>
    ...
    <div class="admin-panel">
        ...
        <div class="main-content">
            ...
            <button class="add-now"><a href="add_mumber.php"> Add-Now</a></button><br>
            <!-- <button class="add-now"><a href="add_mumber_photo.php"> Add-photo</a></button> -->
            ...
            <table>
                ...
                <tbody>
                    ...
                    <?php $result = mysqli_query($conn, "select * from mumbers") ?>
                    ...
                    <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                ...
                                <a class="delete-btn" href="action_mumber.php?del_id=<?php echo $row['id']; ?>"
