...
<body>
    ...
    <div class="admin-panel">
        ...
        <div class="main-content">
            ...
            <button class="add-now"><a href="add_photos.php"> Add-Now</a></button>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <?php $result = mysqli_query($conn, "select * from photos") ?>
                    ...
                    <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                ...
                                <a class="delete-btn" href="action_photos.php?del_id=<?php echo $row['id']; ?>"
