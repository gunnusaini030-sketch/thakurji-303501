...
if (isset($_POST["btn"])){
   ...
   $query = "INSERT INTO register (name, email, password, number) VALUES ('$name', '$email', '$password', '$number')";
        ...
        <div class="main-content">
            ...
            <div class="container">
                <form action="#" method="POST">
                    ...
                    <div class="form">
                        <button type="submit" class="submit-button" name="btn">Create Account</button>
                    </div>
                    <?php echo $msg;?>
