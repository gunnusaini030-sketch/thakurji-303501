    ...
    <div class="admin-panel">
        ...
        <div class="main-content">
            <header class="main-header">
                <h1>Videos details</h1>
                <div class="user-info">
                    <span>Welcome <?php echo ($_SESSION ['admin_users']['name'] )?>🤴</span>
                    <img src="" alt="">
                </div>
            </header>
             <button class="add-now"><a href="add_video.php"> Add-Now</a></button>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <?php  $result= mysqli_query( $conn,  "select * from videos") ?>
                    ...
                    <?php while ( $row = mysqli_fetch_assoc($result)) { ?>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                ...
                                <a class="delete-btn" href="action_videos.php?del_id=<?php echo $row['id']; ?>"
